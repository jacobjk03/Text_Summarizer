...
models = AutoModelForSeq2SeqLM.from_pretrained("nsi319/legal-led-base-16384")
...
def summarize(request: Request, ARTICLE_TO_SUMMARIZE: str = Form(...)):
    ...
    start = time.time()
    input_tokenized = tokenizer.encode(ARTICLE_TO_SUMMARIZE, return_tensors='pt',padding="max_length",pad_to_max_length=True, max_length=6144,truncation=True)
